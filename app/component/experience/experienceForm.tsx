...
import { Experience, FormValues, initialFormValues } from '@/app/state/initialState';
import { DatePicker } from '@mui/lab';

interface ExperienceFormProps {
  onExperienceChange: (index: number, key: keyof Experience, value: any) => void;
  handleChange: (key: keyof FormValues, value: any) => void;
  handleExperienceChange: (index: number, key: keyof Experience, value: any) => void;
}

const ExperienceForm: React.FC<ExperienceFormProps> = ({ onExperienceChange, handleChange, handleExperienceChange }) => {
